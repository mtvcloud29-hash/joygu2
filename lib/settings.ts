...
=======
  email: z.object({ enabled: booleanField, provider: z.enum(["resend", "smtp"]).default("resend"), resendApiKey: stringField, senderEmail: stringField, senderName: stringField, replyTo: stringField, smtpHost: stringField, smtpPort: stringField, smtpUsername: stringField, smtpPassword: stringField, smtpEncryption: stringField, orderEmails: booleanField, shippingEmails: booleanField, newsletterEmails: booleanField, passwordResetEmails: booleanField, welcomeEmails: booleanField }),
  seo: z.object({ siteTitle: stringField, metaDescription: stringField, keywords: stringField, canonicalUrl: stringField, ogImage: stringField, twitterImage: stringField, robotsEnabled: booleanField, sitemapEnabled: booleanField, schemaEnabled: booleanField, googleVerification: stringField, bingVerification: stringField, facebookVerification: stringField }),
  social: z.object({ facebook: stringField, instagram: stringField, youtube: stringField, twitter: stringField, linkedin: stringField, pinterest: stringField, whatsapp: stringField, telegram: stringField, discord: stringField }),
  analytics: z.object({ googleAnalytics: stringField, googleTagManager: stringField, facebookPixel: stringField, microsoftClarity: stringField, hotjar: stringField, metaPixel: stringField, trackingEnabled: booleanField }),
  shipping: z.object({ shippingCharge: stringField, freeShipping: stringField, packagingCharge: stringField, deliveryDays: stringField, courierName: stringField, trackingUrl: stringField, shiprocketEnabled: booleanField, shiprocketEmail: stringField, shiprocketPassword: stringField, shiprocketPickupLocation: stringField, shiprocketAutoCreateShipment: booleanField, shiprocketAutoAssignAwb: booleanField }),
...
=======
export type PublicSettings = SettingsDocument & { configuredSecrets: { payment: boolean; discord: boolean; email: boolean; shipping: boolean } };
>>>>>>> c5c08d70c3339368c786db8aec452e0478facf79
...
=======
  email: { enabled: true, provider: "resend", resendApiKey: "", senderEmail: site.email, senderName: site.name, replyTo: site.email, smtpHost: "", smtpPort: "587", smtpUsername: "", smtpPassword: "", smtpEncryption: "STARTTLS", orderEmails: true, shippingEmails: true, newsletterEmails: true, passwordResetEmails: true, welcomeEmails: true },
  seo: { siteTitle: site.name, metaDescription: site.description, keywords: "handmade clay, pottery, terracotta, Bengal pottery, wholesale ceramics", canonicalUrl: "", ogImage: "/images/brand/joyguru-logo.png", twitterImage: "/images/brand/joyguru-logo.png", robotsEnabled: true, sitemapEnabled: true, schemaEnabled: true, googleVerification: "", bingVerification: "", facebookVerification: "" },
  social: { facebook: "", instagram: "https://instagram.com", youtube: "", twitter: "", linkedin: "", pinterest: "", whatsapp: `https://wa.me/91${site.whatsapp}`, telegram: "", discord: "" },
  analytics: { googleAnalytics: "", googleTagManager: "", facebookPixel: "", microsoftClarity: "", hotjar: "", metaPixel: "", trackingEnabled: false },
  shipping: { shippingCharge: "99", freeShipping: "1999", packagingCharge: "0", deliveryDays: "3–7 working days", courierName: "", trackingUrl: "", shiprocketEnabled: false, shiprocketEmail: "", shiprocketPassword: "", shiprocketPickupLocation: "", shiprocketAutoCreateShipment: false, shiprocketAutoAssignAwb: false },
>>>>>>> c5c08d70c3339368c786db8aec452e0478facf79
...
=======
const secretFields = ["payment.razorpayKeyId", "payment.razorpaySecret", "payment.webhookSecret", "discord.webhookUrl", "email.resendApiKey", "email.smtpPassword", "shipping.shiprocketEmail", "shipping.shiprocketPassword"] as const;
>>>>>>> c5c08d70c3339368c786db8aec452e0478facf79
...
=======
export async function getPublicSettings(): Promise<PublicSettings> { const stored = await getStoredSettings(); return { ...stored, payment: { ...stored.payment, razorpayKeyId: "", razorpaySecret: "", webhookSecret: "" }, discord: { ...stored.discord, webhookUrl: "" }, email: { ...stored.email, resendApiKey: "", smtpPassword: "" }, shipping: { ...stored.shipping, shiprocketEmail: "", shiprocketPassword: "" }, configuredSecrets: { payment: secretFields.slice(0, 3).some((field) => Boolean(getSecret(stored, field))), discord: Boolean(getSecret(stored, "discord.webhookUrl")), email: Boolean(getSecret(stored, "email.resendApiKey")) || Boolean(getSecret(stored, "email.smtpPassword")), shipping: Boolean(getSecret(stored, "shipping.shiprocketEmail")) || Boolean(getSecret(stored, "shipping.shiprocketPassword")) } }; }
>>>>>>> c5c08d70c3339368c786db8aec452e0478facf79
